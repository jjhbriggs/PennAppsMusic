...
import { View, Linking, TouchableHighlight, StyleSheet, Text, Image, ImageURISource, ScrollView } from "react-native";
...
export default function ({
  navigation,
}: StackScreenProps<MainStackParamList, "QueueScreen">) {
    ...
    return (
      <View style={styles.artist}>
        ...
        <View style={[styles.artist3box, {marginRight:0}]}>
          <TouchableHighlight underlayColor="transparent" onPress={() => {animatedPress();}}> 
            <Animatable.View ref={AnimationRef}>
              {added ? <MaterialIcons  name="playlist-add-check" size={35} color={isDarkmode ? colors.neutralLight : colors.neutralDark} />
